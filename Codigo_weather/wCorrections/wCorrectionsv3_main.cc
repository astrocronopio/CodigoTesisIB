...
///
	...
	//ifstream infileatm ("/mnt/Datos/oscar/Trabajo/datos_auger/utctprhdrc_010104_090516.dat");
...
///
	string path 	= "/home/ponci/Desktop/TesisIB/Coronel/PC_Weather_paper/Code/Sh/test.dat";
	string path_fit	= "../old_herald_PC_tresacrodes.dat";
	...
	{    
		while (!infiledata.eof() ){			
			...
			//liness >> utc >> phi >> the >> s1000 >> ds1000 >> energy >> p >> rho >> rhod >> iw;			/// herald
...
///
	...
	ofstream outfile2("../outfile2.dat");
	for(int i = 0;i < nbin; i++)
	{		
...
///
	ofstream outfile3("../outfile3.dat");
	for(int j=0;j<24;j++)
	{
	...
	ofstream outfile4("../outfile4.dat");
	if(dataBin1day!=NULL){
