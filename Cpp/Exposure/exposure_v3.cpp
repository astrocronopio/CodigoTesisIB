...
*/
	...
	int interval = 288;
	const char* out_file_sidereal	= "./sideral_2019_report_on_anisotropy_288_2004_2017.txt";

	const char* out_file_2 		= 	"./solar_2019_report_on_anisotropy_288_2004_2017.txt";
	const char* out_file_a_2 	= 	 "./anti_2019_report_on_anisotropy_288_2004_2017.txt";

	std::cout << "Sidereal "<< std::endl;
	exposure_given_period(T_S, "./sideral_2019_report_on_anisotropy_288_2004_2017_1.txt", utci, utcf, interval);
	exposure_sideral		 ( "./sideral_2019_report_on_anisotropy_288_2004_2017_2.txt", utci, utcf, interval);
