...
ax.set_position( [0.0, -0.1, 1, 1])

plt.text( -30,0.45, "Ref: Aab A. et al. 2020", bbox=dict(facecolor='white', alpha=0.5))
plt.legend(loc='upper left', bbox_to_anchor=(0, 1.05), title="Rango (en EeV)")
