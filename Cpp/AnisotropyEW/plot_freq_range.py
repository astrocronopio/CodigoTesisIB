...
output_file_1="./Files_AllTriggers_0-25_0-5_EeV/output_threshold_0EW_v2.dat"
output_file_2="./Files_AllTriggers_0-5_1_EeV/output_threshold_0EW_v2.dat"
output_file_3="./Files_AllTriggers_1_2_EeV/output_threshold_0EW_v2.dat"
...
f,r,r99 = np.loadtxt(file_plot, usecols=(0,4,8), unpack=True)

y_ticks = np.arange(0.00, 2*np.max(r99), 0.001)
plt.yticks(y_ticks)
plt.ylim(top=1.1*np.max(r99))
