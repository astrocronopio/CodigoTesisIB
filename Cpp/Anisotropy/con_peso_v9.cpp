			   ...
			   unsigned long utci, unsigned long utcf, const char* in_file)
{
	...
	if(myfile.is_open())
	{
		while (!myfile.eof() ){			
            ...
            //El error está aca! Tiene que se utcref para coincidir con RA!!
...
// double ray_given_freq( double freq, const char* in_file, const char* out_file, unsigned long utci , unsigned long utcf){
