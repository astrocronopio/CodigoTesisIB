...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{../clima/delay.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{../clima/eas.png}
...
\begin{figure}[H]
        \begin{subfigure}[b]{0.49\textwidth}
        	\centering
			\includegraphics[width=\textwidth]{../clima/Graphs/clima/presion.png}
			\caption{Presión}
			\label{fig:presion}
		\end{subfigure}%
		\hspace{\fill}
        \begin{subfigure}[b]{0.49\textwidth}
			\centering	
			\includegraphics[width=\textwidth]{../clima/Graphs/clima/densidad_diaria.png}
        ...
        \begin{subfigure}[b]{0.49\textwidth}
        	\centering
			\includegraphics[width=\textwidth]{../clima/Graphs/clima/densidad_media_diaria.png}
        ...
        \begin{subfigure}[b]{0.49\textwidth}
			\centering	
			\includegraphics[width=\textwidth]{../clima/Graphs/clima/densidad_hod.png}
