...
\input{0_Introduccion/introduccion_v6}


\chapter{Métodos}
\graphicspath{{1_Metodo/}}
\input{1_Metodo/metodo_v2}
...
% \chapter{Resultados}
% \graphicspath{{0_Introduccion/}}
% \input{0_Introduccion/anisotropia_v3}
...
\input{4_Weather_Modulation/anisotropia_weather_2020_v1}
...
\input{6_Dipole_1-2_EeV/report_6_bin_1_2_v3}
