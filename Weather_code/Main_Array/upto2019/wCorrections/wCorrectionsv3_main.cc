...
///
	//ifstream infileatm ("/home/ponci/Desktop/TesisIB/Coronel/PC_Weather_paper/Weather/Raw/utctprhdrc_010104_090516.dat");
...
///
	string path 				= "/home/ponci/Desktop/TesisIB/Coronel/Licenciatura/Herald/Herald_weather_noBP.dat";
	string path_fit				= "../Herald_S38_S1000_expected/expected_above_1EeV_all_sin2.dat";
	string path_hour_of_the_day	= "../Herald_S38_S1000_expected/expected_above_1EeV_hour_of_the_day.dat";  //
	string path_hour_expected   = "../Herald_S38_S1000_expected/expected_above_1EeV_rate_hour.dat";	 //
	string path_rate_expected	= "../Herald_S38_S1000_expected/expected_above_1EeV_rate_day.dat" ; //
...
///
	...
	int utcmax = 1535437500;//1451606700;
	int binw = 3600;	
...
///
	...
	//					Inicio		Fin			
	RunFit(*dataBin1hr,1104537600,1535437499,1230768000,1325376000,nbin);	///1451347200 1438387500 1420070400 1370044800 1388534400
