...
plot "../../HDD_weather/Herald/herald_above_1EeV_hour_of_the_day.dat" u 0:(2.566*24*$2/($4)):(2.566*24*sqrt($2)/($4)) w e  pt 7  ps 2 t  'ICRC 2015'
...
set output  "/home/ponci/Desktop/TesisIB/Coronel/TesisIB/IB_style/clima/Graphs/rate_hour_of_the_day/1EeV_ICRC_2019_S38_w_S1000.png"
set autoscale
...
plot "../../HDD_weather/Herald_S38_w_S1000/S38_w_S1000_above_1EeV_hour_of_the_day.dat" u 0:(2.566*24*($2-$1)/($4)) lc rgb 'dark-pink' pt 7  ps 2 t  ''
replot 0 lw 2 dt 2 lc rgb  'black' t ''
...
set ytics 0.001
set autoscale
set yrange [0.1665:0.1741]
set title "Tasa de Eventos media por día  2005-2015 (1 EeV)"
set ylabel "Tasa [km^{-2}día^{-1}]"  offset -0.15
set xrange [-1:24]

plot "../../HDD_weather/Herald_S38_w_S1000/S38_w_S1000_above_1EeV_hour_of_the_day.dat" u 0:(2.566*24*$2/($4)):(2.566*24*sqrt($2)/($4)) w e  lc rgb 'dark-pink' pt 7  ps 2 t  'S38 (w)' ,\
 	 "../../HDD_weather/Herald_S38_w_S1000/S38_w_S1000_above_1EeV_hour_of_the_day.dat" u 0:(2.566*24*$1/($4))  w lp lc rgb "black" lw 1.2  ps 0.8 pt 5  t  'Ajuste'
