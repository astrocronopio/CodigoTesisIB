...
output_herald="/home/ponci/Desktop/TesisIB/Coronel/TesisIB/IB_style/clima/Graphs/rate_por_hora_del_dia_1EeV_ICRC_2019_05_19.png"
...
plot file_herald  u 0:(0.0015+2.566*24*($2-$1)/($4)) pt 7  ps 2 t  '',  0 lw 2 dt 2 lc rgb  'black' t ''
...
replot file_herald u 0:(-0.0015+2.566*24*($1)/($4))  w lp lc rgb "black" lw 1.2  ps 0.8 pt 5  t  'Ajuste'
...
set output  "/home/ponci/Desktop/TesisIB/Coronel/TesisIB/IB_style/clima/Graphs/1EeV_ICRC_2019_S38_w_S1000_05_19.png"
set autoscale
...
plot "../../HDD_weather_2019/Herald_S38_w_S1000/S38_w_S1000_above_1EeV_hour_of_the_day.dat" u 0:(0.0015+2.566*24*($2-$1)/($4)) lc rgb 'dark-pink' pt 7  ps 2 t  ''
...
plot "../../HDD_weather_2019/Herald_S38_w_S1000/S38_w_S1000_above_1EeV_hour_of_the_day.dat" u 0:(2.566*24*$2/($4)):(2.566*24*sqrt($2)/($4)) w e  lc rgb 'dark-pink' pt 7  ps 2 t  'S38 (w)' ,\
 "../../HDD_weather_2019/Herald_S38_w_S1000/S38_w_S1000_above_1EeV_hour_of_the_day.dat" u 0:(-0.0015+2.566*24*($1)/($4))  w lp lc rgb "black" lw 1.2  ps 0.8 pt 5  t  'Ajuste'
