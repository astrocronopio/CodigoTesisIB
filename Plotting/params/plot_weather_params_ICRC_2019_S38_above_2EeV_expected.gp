...
set title "Parámetro ".first_title." S38 no corregido (2 EeV)"
...
replot "../HDD_weather/Herald_S38_S1000_expected/expected_above_2EeV_all_sin2.dat"					u 1:($2+0.00085*0):3 w yerror 	lc rgb  "dark-turquoise"		pt 13  ps 4 lw 2 t 'S38 - ICRC 2019'
fit f7(x) "../HDD_weather/Herald_S38_S1000_expected/expected_above_2EeV_all_sin2.dat"					u 1:($2+0.00085*0):3 yerror via c07, c17, c27
replot f7(x) 																		lc rgb  "dark-turquoise"			lw 2 t ''#
...
replot "../HDD_weather/Herald_S38_S1000_expected/expected_above_2EeV_all_sin2.dat"					u 1:($4-0.099*0):5 w yerror 	lc rgb  "dark-turquoise"		pt 13  ps 4 lw 2 t 'S38 - ICRC 2019'
fit f7(x) "../HDD_weather/Herald_S38_S1000_expected/expected_above_2EeV_all_sin2.dat"				u 1:($4-0.099*0):5 yerror via c07, c17, c27
replot f7(x) 																		lc rgb  "dark-turquoise"			lw 2 t ''#
...
replot "../HDD_weather/Herald_S38_S1000_expected/expected_above_2EeV_all_sin2.dat"				u 1:6:7 w yerror 	lc rgb  "dark-turquoise"		pt 13  ps 4 lw 2 t 'S38 - ICRC 2019'
fit f7(x) "../HDD_weather/Herald_S38_S1000_expected/expected_above_2EeV_all_sin2.dat"				u 1:6:7  yerror via c07, c17, c27
replot f7(x) 																		lc rgb  "dark-turquoise"			lw 2 t ''#
