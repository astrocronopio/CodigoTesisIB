...
file_events="/home/ponci/Desktop/TesisIB/Coronel/Herald/Central/Modified/Herald_simple_modified_bins.dat"

#_______Old Data Set
file_auger_old="/home/ponci/Desktop/TesisIB/Coronel/Herald/Central/Modified/Herald_old_simple_modified.dat"
file_events_old="/home/ponci/Desktop/TesisIB/Coronel/Herald/Central/Modified/Herald_old_simple_modified_bins.dat"
...
#	awk '{if ($9>1500) print $0 }' 	 join_herald_utctprh.dat 		>  join_herald_utctprh_alles_gut.dat
#	awk '{if ($9>1500) print $0 }' 	 join_herald_old_utctprh.dat 	>  join_herald_old_utctprh_alles_gut.dat
#	awk '{if ($9>1500) print $0 }' 	 join_herald_delay.dat 			>  join_herald_delay_alles_gut.dat
#	awk '{if ($9>1500) print $0 }' 	 join_herald_old_delay.dat 		>  join_herald_old_delay_alles_gut.dat
#	
#	rm join_herald_utctprh.dat 	
#	rm join_herald_old_utctprh.dat
#	rm join_herald_delay.dat 		
#	rm join_herald_old_delay.dat 	
#
...
#   awk '{print $4,$2,$6,$7,$8,$9}' join_herald_utctprh_alles_gut.dat   		>  herald_utctprh.dat
#   awk '{print $4,$2,$6,$7,$8,$9}' join_herald_old_utctprh_alles_gut.dat   	>  herald_old_utctprh.dat
#   awk '{print $4,$2,$6,$7,$8,$9}' join_herald_delay_alles_gut.dat   			>  herald_delay.dat
#   awk '{print $4,$2,$6,$7,$8,$9}' join_herald_old_delay_alles_gut.dat   		>  herald_old_delay.dat
#
#   	rm join_herald_utctprh_alles_gut.dat 	
#	rm join_herald_old_utctprh_alles_gut.dat
#	rm join_herald_delay_alles_gut.dat 		
#	rm join_herald_old_delay_alles_gut.dat 	
#
