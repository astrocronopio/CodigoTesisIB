...
file_bash.write("				#utc events  P  Rho Rho The \n")
...
file_bash.write(" \n")
file_bash.write("""	awk '{if ($1<mktime("2015 12 31 23 59 59") && $1>mktime("2005 01 01 00 00 00")) print $0 }' $2 > events_time.dat \n""")
file_bash.write("""	awk '{if ($1<mktime("2015 12 31 23 59 59") && $1>mktime("2005 01 01 00 00 00")) print $0 }' $3 > delay_time.dat \n""")
file_bash.write(" \n")
