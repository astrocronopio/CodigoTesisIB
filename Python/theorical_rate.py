...
def corrections(file_herald, file_herald_expected):
	...
	ap_0     = 0.001	#0.00136547       +/- 0.0002354  
	ap_1     = -0.024 	#-0.0244764       +/- 0.001488   
	ap_2     = 0.024	#0.0239755        +/- 0.001952   
	
	arho_0   = -2.67 	#-2.67356         +/- 0.06895   
	arho_1   = 1.44 		#1.44102          +/- 0.4359    
	arho_2   = 2.06 		#2.05848          +/- 0.5718    
	
	
	brho_0   = -0.969  	#-0.969504        +/- 0.07007 
	brho_1   = 0.93     	#0.937589         +/- 0.4436  
	brho_2   = -0  	#0.608944         +/- 0.5824  
