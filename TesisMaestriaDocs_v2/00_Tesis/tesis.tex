...
%Podemos usar cualquiera de los dos comandos: \input o \include para incluir el texto
 \chapter{Introducción}
	...
	\input{../01_Introduccion/intro_v2.tex}
  
 \chapter{El Observatorio Pierre Auger}
	\graphicspath{{../02_IntroduccionAuger/}}
	\input{../02_IntroduccionAuger/auger.tex}

 	\section{Registro de eventos}
	\graphicspath{{../03_IntroduccionReport/}}
	\input{../03_IntroduccionReport/introduccion_v8}

%  \chapter{Análisis de los efectos del clima sobre los datos del Observatorio Pierre Auger}
\chapter{Modulación del clima para el archivo del disparo estándar en el rango 2004-2018}	
% 	\graphicspath{{../04_Clima/}}
% 	\input{../04_Clima/clima_1_intro.tex}
% 	\input{../04_Clima/clima_2_fit_main.tex}

\chapter{Modulación del clima para el archivo de todos los disparos en el rango 2014-2020 }	
% 	\graphicspath{{../05_Weather_Modulation/}}
% 	\input{../05_Weather_Modulation/weather_modulation_v3.tex}
