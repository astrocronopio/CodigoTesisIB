...
%Podemos usar cualquiera de los dos comandos: \input o \include para incluir el texto
 \chapter{Introducción}
	...
	\input{../IntroduccionBachelor/intro.tex}
  
 \chapter{El Observatorio Pierre Auger}
	\graphicspath{{../IntroduccionAuger/}}
	\input{../IntroduccionAuger/auger.tex}

 \chapter{Registro de eventos}
	\graphicspath{{../IntroduccionReport/}}
	\input{../IntroduccionReport/introduccion_v8}

 \chapter{Modulación del clima para el archivo de todos los disparos en el rango 2014-2020 }	
	\graphicspath{{../Weather_ModulationReport/}}
	\input{../Weather_ModulationReport/weather_modulation_v3.tex}
...
\chapter{Método Rayleigh}
	\graphicspath{{../MetodoReport/}}
	\input{../MetodoReport/metodo_v5}
	
	
\chapter{Resultados del método Rayleigh en el rango 1 EeV - 2 EeV}
