...
% \subsection{Análisis de segundo orden en Fourier}
	...
	\end{figure}
		...
		\caption{ Eventos con sus respectivos pesos}		\label{fig:bin_events_second_order_con}
		 ...
		 Los resultados del análisis de Rayleigh para el segundo armónico se muestran en la Tabla\,\ref{table:parametros_second_order}, donde se comparan los resultados sin los pesos de los hexágonos y con esa corrección en la frecuencia sidérea. %Para comparar la fase del segundo armónico $\phi_2$ con la fase del primer armónico $\phi_1$, se debe tener en cuenta  que el máximo del segundo orden de la aproximación es $2\phi_2$, con esto
