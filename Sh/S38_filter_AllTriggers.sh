...
echo "Este es el archivo que baje en el 2020"
    ...
    auger_file_simple_output_1="/home/ponci/Desktop/TesisIB/Coronel/AllTriggers/S38_analisis/2019/AllTriggers_S38_over_1EeV_2019.dat"
  auger_file_simple_output_1_2="/home/ponci/Desktop/TesisIB/Coronel/AllTriggers/S38_analisis/2019/AllTriggers_S38_over_1_2_EeV_2019.dat"
  auger_file_simple_output_tod="/home/ponci/Desktop/TesisIB/Coronel/AllTriggers/S38_analisis/2019/AllTriggers_S38_2019.dat"
  auger_file_simple_output_2_4="/home/ponci/Desktop/TesisIB/Coronel/AllTriggers/S38_analisis/2019/AllTriggers_S38_over_2_4_EeV_2019.dat"
...
echo "Entre 1 EeV y 2 EeV"
  awk '{if ($2>2 && $22>0 && $23>0 && $48>0 && $43>5 && $44>0 && $37>0 && $12*$47/$37>=5.36  && $12*$47/$37<=10.25 && $3<60 && $48==1) print  $8,$4,$3,$14,$12,$12*$47/$37,$38,$43, $37}' "$auger_file_simple_input" > "$auger_file_simple_output_1_2"

echo "Todos"
  #awk '{if ($2>2 && $22>0 && $23>0 && $48>0 && $43>5 && $44>0 && $37>0 && $48==1) print  $8,$4,$3,$14,$12,$12*$47/$37,$38,$43, $37}' "$auger_file_simple_input" > "$auger_file_simple_output_tod"
