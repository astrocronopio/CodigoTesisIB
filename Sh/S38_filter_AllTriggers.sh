...
echo "Para 1 EeV"
  awk '{if ($2>2 && $22>0 && $23>0 && $48>0 && $43>5 && $44>0 && $37>0 && $12*$47/$37>=5.36) print  $8,$4,$3,$14,$12,$12*$47/$37,$38,$43, $37}' "$auger_file_simple_input" > "$auger_file_simple_output_1"
echo "Entre 1 EeV y 2 EeV"
  awk '{if ($2>2 && $22>0 && $23>0 && $48>0 && $43>=5 && $44>0 && $37>0 && $12*$47/$37>=5.36  && $12*$47/$37>=10.05) print  $8,$4,$3,$14,$12,$12*$47/$37,$38,$43, $37}' "$auger_file_simple_input" > "$auger_file_simple_output_1_2"
