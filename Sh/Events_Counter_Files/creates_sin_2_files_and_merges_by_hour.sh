...
file_delay="$project""Weather/utctprh-binsdelayrho.dat" 
...
#=============================by S38==========================
#filepath="$project""Merged_Herald_Weather/Energy_filter_by_S38/Sin_2/New/"
#file_auger="$project""Merged_Herald_Weather/Herald_weather_S38_no-badperiod.dat"
#file_name="Herald_S38"
#
#python "$project"/CodigoTesisIB/Python/creates_sin_2_files.py  "$filepath" "$file_auger"  "$file_name"
#Loop_through_sin_2  "$filepath" "$file_name"
#
#filepath="$project""Merged_Herald_Weather/Energy_filter_by_S38/Sin_2/Old/"
#file_auger="$project""Merged_Herald_Weather/Old_herald_weather_S38_no-badperiod.dat"
