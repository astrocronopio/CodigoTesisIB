...
#awk '{if ($2>2 && $22>0 && $23>0 && $43>5 && $44>0 && $3<=60 && $8<mktime("2008 12 31 23 59 59") && $8>mktime("2004 12 31 23 59 59")) print  $38}' "$auger_file_simple_input" > energia_2005_2009.dat
#awk '{if ($2>2 && $22>0 && $23>0 && $43>5 && $44>0 && $3<=60 && $8<mktime("2012 12 31 23 59 59") && $8>mktime("2008 12 31 23 59 59")) print  $38}' "$auger_file_simple_input" > energia_2009_2012.dat
#awk '{if ($2>2 && $22>0 && $23>0 && $43>5 && $44>0 && $3<=60 && $8<mktime("2015 12 31 23 59 59") && $8>mktime("2012 12 31 23 59 59")) print  $38}' "$auger_file_simple_input" > energia_2012_2015.dat
awk '{if ($2>2 && $22>0 && $23>0 && $43>5 && $44>0 && $3<=60 && $8<mktime("2018 12 31 23 59 59") && $8>mktime("2015 12 31 23 59 59")) print  $38}' "$auger_file_simple_input" > energia_2015_2018.dat
...
#awk '{if ($2 >2 && $22>0 && $23>0 && $43>5 && $44>0 && $3<=60) print  $39}' "$auger_file_5v_input" > energia_2015.dat
