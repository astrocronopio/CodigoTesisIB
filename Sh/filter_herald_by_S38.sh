...
auger_file_energy_output='/home/ponci/Desktop/TesisIB/Coronel/Herald/Central/Modified/Energy_filter_by_S38/Herald_S38_8EeV.dat'
...
awk '{if ($2>2  && $22>0 && $23>0 && $43>=5 && $44>0 && $3<=60 && $12*$47/$37>=40.37 ) print  $8,$4,$3,$14,$12,$13,$38,$43}' "$auger_file_energy_input" > "$auger_file_energy_output"
