...
awk '{if ($3<60 && $22!=0 && $23!=0 && $44!=0 && $43>=5 && $12*$47/$37> 5.37 ) print  $8,$3,$4,$12,$13,$38}' "$auger_file_energy_input" > "$auger_file_energy_output"
...
awk '{if ($3<60 && $22!=0 && $23!=0 && $44!=0 && $43>=5 && $47> 5.37  ) print  $8,$3,$4,$12,$13,$39}' "$auger_file_5v_energy_input" > "$auger_file_5v_energy_output"