...
awk '{if ($22>0 && $23>0 && $43>5 && $44>0) print  $8,$3,$4,$12,$13,$38}' "$auger_file_simple_input" > "$auger_file_simple_output"
awk '{if ($22>0 && $23>0 && $43>5 && $44>0 && $38>=1 && $3<60) print  $8,$3,$4,$12,$13,$38}' "$auger_file_simple_input" > "$auger_file_simple_output_theta"
...
awk '{if ($22>0 && $23>0 && $43>5 && $44>0) print  $8,$3,$4,$12,$13,$39}' "$auger_file_5v_input" > "$auger_file_5v_output"
awk '{if ($22>0 && $23>0 && $43>5 && $44>0 && $39>=1 && $3<60) print  $8,$3,$4,$12,$13,$39}' "$auger_file_5v_input" > "$auger_file_5v_output_theta"
