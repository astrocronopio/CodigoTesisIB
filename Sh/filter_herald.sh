...
auger_file_simple_input="$project""Herald/Central/Archive/Archive_v6r2p2.dat"
auger_file_simple_output="$project""Herald/Central/Modified/All_Energy/Herald.dat"
...
auger_file_5v_input="$project""Herald/Central/Archive/ArchiveICRCnoBP.dat"
auger_file_5v_output="$project""Herald/Central/Modified/All_Energy/Old_Herald.dat"
...
#This scripts works on the actual auger data set structure (2019) with the simplest data
auger_file_energy_input="$project""Herald/Central/Archive/Archive_v6r2p2.dat"
auger_file_energy_output="$project""Herald/Central/Modified/Energy_above_1EeV/Herald_filter_by_energy_above_1EeV.dat"
...
#This scripts works on the old auger data set structure with the simplest data
auger_file_5v_energy_input="$project""Herald/Central/Archive/ArchiveICRCnoBP.dat"
auger_file_5v_energy_output="$project""Herald/Central/Modified/Energy_above_1EeV/Old_Herald_filter_by_energy_above_1EeV.dat"
