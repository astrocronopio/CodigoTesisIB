...
#filename= "1EeV_all_sin2.dat"
#==============================================================================================================================

#set terminal pdfcairo size 1200,750 enhanced font 'Arial,26'
set terminal qt 10 enhanced  size 1200,750  font 'Arial,26'
...
replot filename u 1:($2):3  w yerror lc rgb 'dark-pink'	pt 13  ps 4 lw 2 t 'Este trabajo'
fit f7(x)  filename		u 1:($2):3  yerror via c07, c17, c27
replot f7(x) lc rgb 'dark-pink'		lw 2 t ''

# set terminal png size 1200,750 enhanced  font 'Arial,26'
...
set terminal qt 12 enhanced  font 'Arial,26'  size 1200,750

set autoscale
first_title="a_ρ"
set ylabel "a_ρ [kg^{-1}m^{3}]"
...
#================================================================================================================================
#Todos los archivos
replot filename 	u 1:4:5  w yerror 	lc rgb 'dark-pink'	pt 13  ps 4 lw 2 t 'Este trabajo'
...
set terminal qt 13  enhanced  size 1200,750 font 'Arial,26'

set autoscale
first_title="b_ρ"
set ylabel "b_ρ [kg^{-1}m^{3}]"
...
replot 		filename	u 1:6:7  w yerror 	lc rgb 'dark-pink'	pt 13  ps 4 lw 2 t 'Este trabajo'
